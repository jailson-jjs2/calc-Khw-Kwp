...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		GridBagLayout layout = new GridBagLayout();  // ORGANIZADOR DE LINHAS E COLUNAS
		GridBagConstraints c = new GridBagConstraints();
		
		setLayout(layout); 
		
		c.weightx = 1; // CENTRALIZA OS BOTÕES
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH;
		
		// LINHAS DA CALC
		adicionarBotao("AC" , COR_CINZA_ESCURO, c, 0, 0);
		adicionarBotao("kWp", COR_CINZA_ESCURO, c, 1, 0);
		adicionarBotao("kWh"  , COR_CINZA_ESCURO, c, 2, 0);
	...
	private void adicionarBotao(String texto, Color cor, GridBagConstraints c, int x, int y) {
		...
		botao.addActionListener(this); // ACIONA O BOTÃO 
		add(botao, c);
	}
